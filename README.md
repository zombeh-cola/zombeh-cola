...
<div id="header" align="left">
⤷ культурно-фандомные: анти-шипперы, канон-войны, полишиппинг-фобия, хейт рейрпейры, антисня, антиселфшипперы / осканонщики, собственники (ноншейры), которые запрещают поддерживать дабллов, крабовая ментальность.
...
⤷ красные флаги: не общайтесь со мной, если вы поддерживаете педофилию & грумерство, гомофобию & гетерофобию, поддержка трансов (возможно исключение, сорри но нет), сексизм, расизм, фетишизация лгбтк (в меру), гиперсексуализация всего (в меру), приписывайте персонажам ориентацию.
...
⤷ отдельная категория, не входящая в основные разделы: не общайтесь со мной, если вы поддерживаете определенные пейринги (например: сукуфуши & сукуго & сукурозу), однако, не упоминайте при мне в любых проявлениях, ибо эти пейринги мне некомфортны и могу словить триггер
