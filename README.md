...
⤷ красные флаги: не общайтесь со мной, если вы поддерживаете пед7филию & грумерство, г7мофобию & г7терофобию, поддержка тр7нсов (возможно исключение, сорри но нет), с7ксизм, р7сизм, фетишизация л7бтк (в меру), гиперс7ксуализация всего (в меру), приписывайте персонажам ориентацию.
