...
⤷ еще одна отдельная категория, не входящая в основные разделы: сторонники травли, сторонники изнсилвания или люди, оправдывающие н7силие, фанаты ТБАТФ, а также не общайтесь со мной, если вы поддерживаете определенные пейринги, которые мне неприятны (например: сукуфуши & сукурозу или томторды), однако, не упоминайте при мне в любых проявлениях, также касается определенных триггерных тем ;; имеешь против черного и дирти шутки, шутки про пятки и жир.
